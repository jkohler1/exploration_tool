...
class ModelPixplot:
    ...
    def __init__(self,tiles_path,dimensionality_reduction,output,model_type, model_name, processing_unit, 
        ...
        for i in range(len(model_type)):
            ...
            for dim in dimensionality_reduction:
                ...
                if compteur_reduc == 0 & i == 0:
                    if self.default_clustering:
                        self.generate_default_clustering(reduc_dim)
                compteur_reduc+=1
    ...
    def generate_default_clustering(self,reduc_dim):
        # Rem col 'filename' 
        ...
        points_clusters.to_csv(self.output + 'points_clusters.csv', index=False)
